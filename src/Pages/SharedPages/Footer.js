        ...
        <div>
            ...
            className="footer p-10">
                <aside className="items-center grid-flow-col">
                    ...
                    <p className='text-accent font-semibold'>Copyright © 2024 - All right reserved by Nahid Hasan</p>
                </aside> 
                <nav className="grid-flow-col gap-4 md:place-self-center hidden lg:flex md:justify-self-end">
